...
Windows includes the option to install and run Linux inside of Windows. It is simple to install and set up. Follow the instructions [from here](https://docs.microsoft.com/en-us/windows/wsl/install), the part
under “Install WSL command”.
